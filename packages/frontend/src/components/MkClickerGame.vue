...
<div>
	<div v-if="game.ready" :class="$style.game">
		...
		<div :class="$style.count" class="" data-testid="count"><i class="ti ti-cookie" style="font-size: 70%;"></i>{{ number(cookies) % 100 == 0 && number(cookies) <= 0 ? "Awesome!" : "" }} {{ number(cookies) }}</div>
